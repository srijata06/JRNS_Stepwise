...
// [[Rcpp::export]]
List JRNShp(mat B_ini, mat Omega_ini, mat Y, mat X, int nmc, int burnin, double r1 = 1e-4, double s1 = 1e-8,double alpha1 = 1,double beta1 = 1,double alpha2 = 1, double beta2 = 1){
