...
// [[Rcpp::export]]
List StepB(mat B_ini, vec sigma2_ini, mat Y, mat X, int nmc, int burnin, double r1 = 1e-4, double s1 = 1e-8,double alpha1 = 1, double beta1 = 1, int hyp = 0){
	...
	return(List::create(Named("Bcount") = Bcount,Named("Bsum") = Bsum, Named("B") = out, Named("Bhat") = Bhat, Named("time") = time_taken ));
}
